...
const HoverMenu = ({children, hoverMenu}) => {
  ...
  return (
    <div className='md:relative flex md:flex-col items-center'>
      ...
      { // Pop up menu
        isHovered &&
        <div className='absolute left-0 md:left-auto md:absolute top-14 md:top-auto md:-bottom-24 bg-white border-b-2 md:border-2 border-gray-200 md:rounded-xl w-screen md:w-20 md:h-20 z-30'>
